...
<head>
    ...
    <!-- Favicons -->
    <link rel="apple-touch-icon" href="../../assets/img/favicon/laravel.png" sizes="180x180">
    <link rel="icon" href="../../assets/img/favicon/laravel.png" sizes="32x32" type="image/png">
    <link rel="icon" href="../../assets/img/favicon/laravel.png" sizes="16x16" type="image/png">

    <link rel="mask-icon" href="../../assets/img/favicon/safari-pinned-tab.svg" color="#563d7c">
    <link rel="icon" href="../../assets/img/favicon/laravel.png">
