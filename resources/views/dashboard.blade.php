                ...
                <div class="row d-block d-xl-flex align-items-center">
                    ...
                    <div class="col-12 col-xl-7 px-xl-0">
                        <div class="d-none d-sm-block">
                            <h2 class="h6 text-gray-400 mb-0">Jumlah Donatur</h2>
                            <h3 class="fw-extrabold mb-2">{{ $totalDonatur }}</h3>
                        </div>
        ...
        <div class="card border-0 shadow">
            <div class="card-body">
                <div class="row d-block d-xl-flex align-items-center">
                    ...
                    <div class="col-12 col-xl-7 px-xl-0">
                        <div class="d-none d-sm-block">
                            <h2 class="h6 text-gray-400 mb-0">Jumlah Staff</h2>
        ...
        <div class="card border-0 shadow">
            <div class="card-body">
                <div class="row d-block d-xl-flex align-items-center">
                    ...
                    <div class="col-12 col-xl-7 px-xl-0">
                        <div class="d-none d-sm-block">
                            <h2 class="h6 text-gray-400 mb-0"> Jumlah Penerima Donasi</h2>
                            <h3 class="fw-extrabold mb-2">{{ $totalPenerimaDonasi }}</h3>
                        </div>
                ...
                <div class="card border-0 shadow">
                    <div class="card-header">
                        <div class="row align-items-center">
                            <div class="col">
                                <h2 class="fs-5 fw-bold mb-0">Daftar Donatur</h2>
                            </div>
                            <div class="col text-end">
                                <a href="/donatur" class="btn btn-sm btn-primary">See all</a>
                            </div>
                        </div>
                    </div>
                    <div class="table-responsive">
                        <table class="table align-items-center table-flush">
                            ...
                            <tr>
                                <th class="border-bottom" scope="col">Nama Lengkap</th>
                                <th class="border-bottom" scope="col">NIK</th>
                                <th class="border-bottom" scope="col">Alamat</th>
                                <th class="border-bottom" scope="col">Nomor HP</th>
                            </tr>
                            </thead>
                            <tbody>
